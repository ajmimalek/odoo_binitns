...
class ResConfigSettings(models.TransientModel):
    ...
    def set_values(self):
        ...
        if(any(colors_changed)):
            variables = [
                {'name': 'o-brand-odoo', 'value': self.theme_color_brand or "#b24f38"},
                {'name': 'o-brand-primary', 'value': self.theme_color_primary or "#b24f38"},
                {'name': 'mk-required-color', 'value': self.theme_color_required or "#8bafcc"},
