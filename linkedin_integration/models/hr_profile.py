...
class HrProfile(models.Model):
    _name = 'linkedin_integration.profile'
    _description = 'Model for collected profiles for specific job'

    name = fields.Char('Nom du Profile')
    current_company = fields.Text('Entreprise actuelle')
    school = fields.Text('École')
    picture = fields.Text('Picture')
    linkedin_url = fields.Char('LinkedIn URL')
    months_experiences = fields.Integer("Mois d'experiences")
